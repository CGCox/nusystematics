...
class BYPara : public nusyst::IGENIESystProvider_tool {
public:
  explicit BYPara(fhicl::ParameterSet const &);
  ...
  std::string AsString() { return "BYPara"; }
